	...
	return (
		<div className="notification-item">
			...
			>
				...
				<ChevronDown
					size={18}
					className={`notification-arrow ${open ? "open" : ""}`}
				/>
			</button>
			...
			<div
				...
				style={{
					maxHeight: open ? `${bodyRef.current?.scrollHeight ?? 0}px` : "0px",
				}}
			>
				<div className="notification-body-content">
					<p>
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore
						doloribus molestias accusantium maxime voluptatum odit ratione.
